---
  ...
  template: ~/Dropbox/Big Data/Final paper/svm-latex-ms.tex
  title: "Replication Material for Political Polarization of YouTube Comments on Migration-Related Issues"
  thanks: "Final paper submitted as part of the course 'Big Data and Immigration Research' in Spring 2019."
    ...
    - name:   Christopher Brehm 
      email:  xxx@gmail.com
    - name:   Klara Kuhn 
      email:  klkuhn@mail.uni-mannheim.de
    - name:   Cosima Meyer 
      email:  cosima.meyer@uni-mannheim.de
    - name:   Antje Rosebrock 
      email:  antje.rosebrock@mzes.uni-mannheim.de
